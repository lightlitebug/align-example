...
class AlignmentFractionOffset extends StatefulWidget {
  @override
  _AlignmentFractionOffsetState createState() =>
      _AlignmentFractionOffsetState();
}

class _AlignmentFractionOffsetState extends State<AlignmentFractionOffset> {
